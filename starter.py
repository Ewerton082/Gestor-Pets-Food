...
"""
        ...
        self.comanda = ctk.CTkButton(self, text="Comandas", font=('sans', 20), width=165)
        self.comanda.grid(row=0, column=0, padx=3, pady=(10, 0))

        self.plano = ctk.CTkButton(self, text="Funções futuras", font=('sans', 20), width=165)
        self.plano.grid(row=0, column=1, padx=3, pady=(10, 0))

        self.devedores = ctk.CTkButton(self, text="Funções futuras", font=('sans', 20), width=165)
        self.devedores.grid(row=0, column=2, padx=3, pady=(10, 0))

        self.title = ctk.CTkLabel(self, text="Imprimir comandas", font=('times', 33))
        self.title.grid(row=1, column=0, columnspan=3, sticky='we', padx=10, pady=(20, 0))

        # Labels do Formulario

        self.form_frame = ctk.CTkFrame(self, height=380, corner_radius=25, border_width=2)
        self.form_frame.grid(row=2, column=0, columnspan=3, padx=25, pady=(10, 0), sticky='we')

        self.dono_label = ctk.CTkLabel(self.form_frame, text="Tutor:", font=('times', 25, 'bold'))
        self.dono_label.grid(row=0, column=0, pady=(10, 0), padx=10)

        self.telefone_label = ctk.CTkLabel(self.form_frame, text="Telefone:", font=('times', 25, 'bold'))
        self.telefone_label.grid(row=1, column=0, pady=(10, 0), padx=10)

        self.pet_label = ctk.CTkLabel(self.form_frame, text="Pet:", font=('times', 25, 'bold'))
        self.pet_label.grid(row=2, column=0, pady=(10, 0), padx=10)

        self.pos_label = ctk.CTkLabel(self.form_frame, text="Posição:", font=('times', 25, 'bold'))
        self.pos_label.grid(row=3, column=0, pady=(10, 0), padx=10)

        self.procedimento_label = ctk.CTkLabel(self.form_frame, text="Serviço:", font=('times', 25, 'bold'))
        self.procedimento_label.grid(row=4, column=0, pady=(10, 0))

        self.obser_label = ctk.CTkLabel(self.form_frame, text="↡ Observações ↡", font=('times', 25, 'bold'))
        self.obser_label.grid(row=5, column=0, columnspan=2, pady=(10, 0), padx=10, sticky='we')
        ...
        self.dono_inp.grid(row=0, column=1, pady=(10, 0))
        ...
        self.telefone_inp.grid(row=1, column=1, pady=(10, 0))

        self.pet_inp = ctk.CTkEntry(self.form_frame, placeholder_text='Nome do pet', font=('sans', 20),
                                    width=200, border_width=1, border_color='black', corner_radius=5, )
        self.pet_inp.grid(row=2, column=1, pady=(10, 0))
        ...
        self.obser_inp = ctk.CTkEntry(self.form_frame, font=('sans', 20), border_width=1, border_color='black',
                                      ...
                                      height=35,
                                      justify='center')
        self.obser_inp.grid(row=6, column=0, columnspan=2, sticky='we', padx=10, pady=(5, 10))
        ...
        self.imprimir.grid(row=7, column=0, columnspan=2, pady=(5, 15))
